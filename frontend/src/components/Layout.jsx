...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      <div className="fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 border-r border-gray-800 transform lg:translate-x-0 transition-transform duration-300 ease-in-out"
