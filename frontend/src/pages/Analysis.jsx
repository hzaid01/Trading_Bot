      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <div className={`px-4 py-2 rounded-lg text-xs ${
            data.mode === 'live' ? 'bg-primary-500/10 text-primary-500' : 'bg-gray-500/10 text-gray-400'
          }`}>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <span className={`font-semibold ${
                    data.indicators.rsi > 70 ? 'text-danger-500' :
                ...
                <div className="w-full bg-gray-800 rounded-full h-2">
                  <div
                    className={`h-2 rounded-full ${
                      data.indicators.rsi > 70 ? 'bg-danger-500' :
              ...
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <span className={`font-semibold ${
                    data.indicators.macd.histogram > 0 ? 'text-primary-500' : 'text-danger-500'
                  }`}>
                ...
                <div key={index} className={`p-4 rounded-lg border ${
                  ...
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className={`font-semibold capitalize ${
                      block.type === 'bullish' ? 'text-primary-500' : 'text-danger-500'
                    }`}>
                      {block.type}
                    </span>
                  </div>
